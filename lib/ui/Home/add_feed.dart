  ...
  void onSendMessage(String content) {
    if (content.trim() != '') {
      ...
      var documentReference =
          Firestore.instance.collection('feed').document(time);
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: Text(
                            "WARNING!\n\nWrite only about your problem.\n\nDo not include personal data, passport, credit card information or other valuable information that may be used by attackers.\n\nDo not trust people completely.\n\nGood luck.",
                            style: GoogleFonts.montserrat(
